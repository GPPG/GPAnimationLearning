...
{
    NSArray *tempDataArray = self.flightArrray[IsBeiJing];
    ...
    self.flightStatus = tempDataArray[8];
}
#pragma mark - 懒加载
- (NSArray *)flightArrray
{
    if (!_flightArrray) {
        _flightArrray = @[@[@"2017 04 10:47",@"NH 2017",@"T1 A33",@"北京",@"上海",@"bg-snowy",@"1",@"1",@"飞行"],@[@"2017 04 18:40",@"AE 1107",@"045",@"上海",@"哈尔滨",@"bg-sunny",@"0",@"0",@"延迟"]];
    }
